OBJS = interface.o commands.o commands_repl.o get_commands.o repl.o main.o
SOURCE = code/interface/interface.c code/commands/commands.c code/commands_repl_c/commands_repl.c code/get_commands/get_commands.c code/repl_code/repl.c main.c
OUT = main
CC = gcc
CFLAGS = -g3 -c -Wall
LFLAGS =
